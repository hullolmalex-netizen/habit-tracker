                ...
                <div class="space-y-3">
                    @foreach($habits as $habit)
                        ...
                        <div class="flex items-center gap-4 p-3 rounded-xl border
                            ...
                            @if($done)
                                <span class="text-xs font-medium text-green-600 dark:text-green-400 shrink-0">Done ✅</span>
                            @else
                                <span class="text-xs font-medium text-yellow-600 dark:text-yellow-400 shrink-0">Pending</span>
                            @endif
                        </div>
                    @endforeach
                </div>
