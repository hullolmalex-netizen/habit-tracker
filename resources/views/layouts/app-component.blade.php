    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
            <div class="flex items-center justify-between px-4 md:px-6 h-16">
                ...
                <h1 class="text-base md:text-lg font-semibold text-gray-900 dark:text-white">
        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-6">
            ...
            @if(session('success'))
                <div class="flash-message mb-4 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200
                            dark:border-green-700 rounded-xl text-green-800 dark:text-green-200 text-sm flex items-center gap-2">
                    ✅ {{ session('success') }}
                </div>
            @endif
            @if(session('error'))
                <div class="flash-message mb-4 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200
                            dark:border-red-700 rounded-xl text-red-800 dark:text-red-200 text-sm flex items-center gap-2">
                    ❌ {{ session('error') }}
                </div>
            @endif
